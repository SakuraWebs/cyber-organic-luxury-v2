...
const systemInstruction = `Eres el 'Asistente Virtual' de la agencia Cyber Organic, una agencia global y sin fronteras con base estratégica en Hispanoamérica. Tu tono es elegante, tecnológico, sofisticado, servicial y altamente persuasivo.
...
if (!server.includes('/api/chat')) {
  server = server.replace('app.post("/api/create-mercadopago-preference"', newRoutes + '\n  app.post("/api/create-mercadopago-preference"');
}
